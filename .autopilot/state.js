...
{
  "slug": "pr49-findings",
  "dir": "2026-09-14-pr49-findings--wip",
  ...
  "updatedAt": "2026-09-15T01:12:00+04:00",
  "finishedAt": null,
  "stages": [
    ...
    { "id": "build",     "status": "active", "startedAt": "2026-09-14T23:20:00+04:00" },
    { "id": "review",    "status": "pending" },
    { "id": "final",     "status": "pending" }
  ],
  "requirements": {
    "total": 14, "done": 0, "inTicket": 13, "inSpec": 0,
  ...
  "tickets": [
    { "id": "01", "startedAt": "2026-09-14T23:20:00+04:00", "title": "Граница отказа: отчёт при любом исходе",
      ...
      "blockedBy": [], "wave": 1, "zone": ["src/agent_skill_adapter/convert.py","tests/unit/","docs/prd/"], "status": "done", "finishedAt": "2026-09-15T01:00:00+04:00", "tests": "make check -> 123 passed", "commit": "pending",
    ...
    { "id": "02", "startedAt": "2026-09-14T23:20:00+04:00", "title": "Тексты и политика языка",
      ...
      "blockedBy": [], "wave": 1, "zone": ["AGENTS.md",".autopilot/"], "status": "done", "finishedAt": "2026-09-15T00:20:00+04:00", "tests": "make check -> 118 passed", "commit": "pending",
      "retries": 0, "repairs": 1, "handoffs": 0 },
    { "id": "03", "startedAt": "2026-09-15T01:00:00+04:00", "title": "Три значения float, которых в JSON нет",
      "requirements": ["R03"],
      "blockedBy": ["01"], "wave": 2, "zone": ["src/agent_skill_adapter/convert.py","tests/unit/"], "status": "repair",
      "retries": 0, "repairs": 1, "handoffs": 0 }
  ],
  "singlePass": null,
