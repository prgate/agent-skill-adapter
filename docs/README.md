# Agent Skill Adapter Documentation

Welcome to the **Agent Skill Adapter** documentation hub.

## 📚 Core Documents

### Product Requirements Documents (PRD)
- [PRD-001: Agent Skill Adapter](prd/PRD-001-agent-skill-adapter.md) — зачем продукт нужен, что входит в первую версию, 33 требования и что сознательно отложено.
